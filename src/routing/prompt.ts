...
2. If it is a request for past data (a summary, total, report, or a list/details of expenses for a day or period), choose "report". (Note: if they ask for a report of a specific category, or "lista wydatków" / "show what I spent", it is still a "report").
...
- report: requesting to calculate, summarize, or list past expenses for a period.
